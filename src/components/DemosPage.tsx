            ...
            <article key={demo.href} className={cardShell}>
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-auto inline-flex items-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
                >
                  Open Demo
                </a>
              </div>
